# Aula 26 REVISÃO LISTAS 2 - 13-12-2019
...
pop(indice)
# ele remove o item, mas tem que colcoar a posição dele
...
###################### .remove() ######################
remove(valor) # ele remove o item que vc colocar e não a posição dele

...
class Cadastro:
    ...
    def ler(self):
        try:
            ...
            arquivo = open  ('Aula23/Exercícios/cadastro2.txt', 'a')
        ...
        finally: #garante que o arquivo vai ser fechado no final depois de manipular o mesmo
            arquivo.close() 

    def salvar(self,nome,atributo='a'):
        try:
            arquivo = open(f'Aula23/Exercícios/cadastro2/{nome}.txt',atributo)

...
print(lista[0])
print (lista[2])
print(f'{lista[1][1]}, {lista[1][2]}, {lista[1][5]}, {lista[1][-1]}')
print (f'{lista[2][1]}, {lista[2][-1]}, {lista[2][2]}, {lista[2][0]}')
print (f'Frutas: {lista[1][2]}, {lista[1][4]}, Verduras: {lista[2][4]}, {lista[2][2]}, Legumes: {lista[3][1]}, {lista[3][1]},{lista[3][4]}, {lista[3][5]}')
print (f'{lista[1][0]}, {lista[3][1]}, {lista[2][2]}, {lista[2][-1]}, {lista[1][0]}, {lista[2][4]}')
print (f'Fruta: 3kg de {lista[1][2]}, 8kg de {lista[1][3]}, 4.5kg de {lista[1][5]}, 1kg de {lista[1][-1]}')
print (f'Verduras: 5 maços de {lista[2][-1]}, 4 pés de{lista[2][0]} e {lista[2][0]}')
print (f'Legumes: 1kg de feijão {lista[3][0]}, 2kg de {lista[3][5]}, 1kg de {lista[3][-1]}, e 1 pacote de {lista[3][1]}')
print (lista[3])
